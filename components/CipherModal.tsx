...
interface CipherModalProps {
  onClose: () => void;
}

const CipherModal: React.FC<CipherModalProps> = ({ onClose }) => {
  useEffect(() => {
  ...
  const embedUrl = "https://bible-names-numbers-mastery-759385455270.us-west1.run.app/";
    ...
    >
      ...
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-700 flex-shrink-0">
          <h2 id="cipher-title" className="text-xl font-serif text-brand-gold tracking-wider">
            777 CIPHER
          </h2>
          <button 
            onClick={onClose} 
