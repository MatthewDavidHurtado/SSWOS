        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-0">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between min-h-[4rem] sm:h-16 gap-3 sm:gap-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-brand-dark/90 backdrop-blur-sm border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden animate-fade-in-down">
                  <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                    ...
                    <a href="https://copy-of-official-v3-malcolm-kingley-super-mentor-779946580524.us-west1.run.app/" target="_blank" rel="noopener noreferrer" className={dropdownItemStyle} role="menuitem" onClick={() => setIsDropdownOpen(false)}>
