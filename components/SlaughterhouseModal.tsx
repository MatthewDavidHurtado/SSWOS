...
interface SlaughterhouseModalProps {
  onClose: () => void;
}

const SlaughterhouseModal: React.FC<SlaughterhouseModalProps> = ({ onClose }) => {
  useEffect(() => {
  ...
  return (
    <div 
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="slaughterhouse-title"
    ...
    >
      ...
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-700 flex-shrink-0">
          <h2 id="slaughterhouse-title" className="text-xl font-serif text-brand-gold tracking-wider">
            False Belief Slaughterhouse
          </h2>
          <button 
            onClick={onClose} 
            ...
            aria-label="Close Slaughterhouse"
          >
...
export default SlaughterhouseModal;
